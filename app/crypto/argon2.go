...
const dummyHash = "$argon2id$v=19$m=65536,t=3,p=2$Woo1mErn1s7AHf96ewQ8Uw$D4TzIwGO4XD2buk96qAP+Ed2baMo/KbTRMqXX00wtsU"
...
func ArgonDummyCompare() {
	_, _ = ArgonCompareHash(RandomString(), dummyHash)
}
